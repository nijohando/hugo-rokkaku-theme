...
(defstyles main
  ...
  (footer/layout)
   (brand/component)
  (stamp/component "small" 60 12 10 2 2 "#55295b")
  ;(stamp/component "small" 60 12 10 2 2 "#5a544b")
  ;(stamp/component "small" 60 12 10 2 2 "#df7163")
  ;(stamp/component "small" 60 12 10 2 2 "#74325c")
  ;(stamp/component "small" 60 12 10 2 2 "#c9171e")
